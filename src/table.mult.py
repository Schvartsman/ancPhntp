...
for ii in range(len(fines)-1):
    ...
    while(fines[0][n] != '\n'):
        ...
        if j > i:
            ...
            n = n + 1
    f = open('/home/master/table.txt', 'w')
    out = '/home/master'
    f.write(string)
    f.close()
    e = 'Eye'
    ...
    font.bold = False
    print('edge')
    doc.save(out+"/"+fines[ii+1].split(',')[0]+".phen.docx")
